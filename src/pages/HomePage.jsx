...
const HomePage = () => {
  ...
  return (
    <div className="HomePage">
      <header className="w-100 min-vh-100 d-flex align-items-center pt-lg-0 pt-4 overflow-hidden">
        <Container>
          <Row className='header-box d-flex align-items-center pt-5'>
            <Col lg="6">
              <h1 className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>Temukan <br/> <span>Bakat Kreatifitasmu</span> <br/> Bersama Kami!</h1>
              <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur labore rem illo perspiciatis eligendi molestiae!</p>
      ...
      <div className="kelas w-100 min-vh-100">
        <Container>
          ...
          {kelasTerbaru.map(kelas => {
            return(
              <Col key={kelas.id} className='p-0 bg-white shadow rounded ' data-aos="fade-up" data-aos-duration="1000" data-aos-delay={kelas.delay}>
              ...
              <SwiperSlide key={data.id} className='shadow-sm'>
                ...
                <div className='people'>
                  ...
                  <div>
                    ...
                    <p className='m-o fw-bold'>{data.skill}</p>
                  </div>
                </div>
              </SwiperSlide>
            )
